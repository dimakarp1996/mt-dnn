...
from mt_dnn.batcher import (
    ...
    MultiTaskUniformBatchSampler,
    MultiTaskAnnealBatchSampler,
...
def model_config(parser):
    ...
    # bin samples
    parser.add_argument("--bin_on", action="store_false")
...
def train_config(parser):
    ...
    parser.add_argument("--sampling", default='default', type=str)
...
def main():
    ...
    if args.local_rank != -1:
    ...
    elif args.sampling in ['default', 'plain']:
        print(f'Using default sampling - plain sampling. Bins {args.bin_on}')
        ...
        print(f'Using uniform sampling. Bins {args.bin_on}')
        multi_task_batch_sampler = MultiTaskUniformBatchSampler(
            train_datasets,
            args.batch_size,
            args.mix_opt,
            args.ratio,
    ...
    elif args.sampling == 'anneal':
        print(f'Using anneal sampling. Bins {args.bin_on}')
        multi_task_batch_sampler = MultiTaskAnnealBatchSampler(
            train_datasets,
            args.batch_size,
            args.mix_opt,
            args.ratio,
        ...
        raise Exception(f'Unsupported argument {args.sampling}')
