...
def main(args):
    ...
    canonical_data_suffix = "canonical_san_data"
    ...
    dump_rows(sst_train_data, sst_train_fout, DataFormat.PremiseAndOneHypothesis)
    dump_rows(sst_dev_data, sst_dev_fout, DataFormat.PremiseAndOneHypothesis)
    dump_rows(sst_test_data, sst_test_fout, DataFormat.PremiseAndOneHypothesis)
    ...
    dump_rows(cola_train_data, cola_train_fout, DataFormat.PremiseAndOneHypothesis)
    dump_rows(cola_dev_data, cola_dev_fout, DataFormat.PremiseAndOneHypothesis)
    dump_rows(cola_test_data, cola_test_fout, DataFormat.PremiseAndOneHypothesis)
